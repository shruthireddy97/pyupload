...
const ChatPage = () => {
  ...
  const [chats, setChats] = useState([
    { id: 1, sender: 'John Doe', text: 'Hello! How can I help you today?', time: '10:00 AM' },
    { id: 2, sender: 'Me', text: 'I have a question about the digital skills course', time: '10:02 AM' },
    { id: 3, sender: 'John Doe', text: 'Sure, what would you like to know?', time: '10:03 AM' },
  ]);
